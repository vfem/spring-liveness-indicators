...
| **[Core Components](file:///c:/workdir/spring-liveness-indicators/docs/core-components.md)** | Deep dive into dynamic container resolution via Spring Kafka APIs, offset comparison algorithm, and shutdown | [`CommittedOffsetMovementCheck`](file:///c:/workdir/spring-liveness-indicators/src/main/java/io/github/vfem/livenesscheck/spring/kafka/CommittedOffsetMovementCheck.java) |
